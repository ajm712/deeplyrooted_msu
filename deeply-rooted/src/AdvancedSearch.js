        ...
        return(
            ...
            <table className='tableModal'> 
                <tr>
                    ...
                    <td>
                            <input className="textBoxModal" type="text"  name="subject" value={this.state.name} onChange={this.handleChange}/>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>            
                        <input className="textBoxModal" type="text"  name="title" value={this.state.name} onChange={this.handleChange}/>
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                            <input className="textBoxModal" type="text"  name="rights" value={this.state.name} onChange={this.handleChange}/>
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                            <input className="textBoxModal" type="text"  name="collection" value={this.state.name} onChange={this.handleChange}/>
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                            <input className="textBoxModal" type="text"  name="author" value={this.state.name} onChange={this.handleChange}/>
                    </td>
                </tr>
                <tr>
                    <td>
           ...
           <center><input className='submitModal' type="submit" name="subject" value="Submit" onClick={this.handleSubmit}/>
           <button className='closeModal' onClick={() => this.closeModal()}>Close</button></center>
            </div> 
